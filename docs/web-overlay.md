...
3. Customize content, Mii backing, element placement, background, border lighting, and animations.
...
- create an always-on-top frameless desktop window; or
- upload a local background once and make it available to a separate OBS/TikTok browser process.

For a custom web background, use an absolute HTTPS image URL. Use the desktop edition for automatic identity, multi-license following, local image uploads, tray controls, and the floating badge.
